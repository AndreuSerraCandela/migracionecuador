// codeunit 76037 "Genera Formatos  E. Nomina EC"
// {
...
//         if ConfNomina."Fecha secuencia" <> Today then
//             ConfNomina."Secuencia de archivo Batch" := '01'
//         else
...
//                 BancosNom.Get(EC.Banco);

//                 //GRN 29/03/2021       IF EC.Banco = DIPG."Cod. Banco" THEN
//                 if BancosNom.Formato = DIPG."Cod. Banco" then begin
//                     CERO := PadStr(CERO, 10 - StrLen(DIPG."Numero Cuenta"), '0');
//                     Lin_Body += CERO + Format(DIPG."Numero Cuenta");
//                     Lin_Body += Format(Round((HCN."Total Ingresos" + HCN."Total deducciones"), 0.01) * 100,
...
//         User.RESET;
//         User.SETFILTER("User Name",Filtro);
//         User.FINDFIRST;
...
//                  BEGIN
//                   CuerpoMail := 'Estimado Colaborador:';
//                   Mail2.CreateMessage(User."Name 2",UserSetup."E-Mail",Vendor."E-Mail",Subject,'',TRUE);
