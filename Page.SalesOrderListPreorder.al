page 55003 "Sales Order List Preorder"
{
    ApplicationArea = all;
            ...
            group("F&unctions")
            {
                ...
                action("Send A&pproval Request")
                {
                    ...
                    begin
                        ...
                        if ApprovalMgt.CheckSalesApprovalPossible(Rec) then
                            ApprovalMgt.OnSendSalesDocForApproval(Rec); //MIGEC
                    end;
                }
                action("Cancel Approval Re&quest")
                {
                    ...
                    begin
                        ...
                        WorkflowWebhookMgt.FindAndCancel(rec.RecordId); //MIGEC
                    end;
                }
            ...
            group("P&osting")
            {
                ...
                action("P&ost")
                {
                    ...
                    begin
                        ...
                        if ApprovalMgt.PrePostApprovalCheckSales(Rec) then begin  //MIGEC
                ...
                action("Post and &Print")
                {
                    ...
                    var
                        ...
                        ApprovalMgt: Codeunit "Approvals Mgmt.";
                    begin
                        //IF ApprovalMgt.PrePostApprovalCheck(Rec,PurchaseHeader) THEN  //MIGBO
                        if ApprovalMgt.PrePostApprovalCheckSales(Rec) then begin  //MIGBO
                                                                                  //IF ApprovalMgt.TestSalesPrepayment(Rec) THEN //MIGBO
                            if ApprovalMgt.CheckSalesApprovalPossible(Rec) then
                                Error(StrSubstNo(Text001, rec."Document Type", rec."No."))
                            else begin
                                //IF ApprovalMgt.TestSalesPrepayment(Rec) THEN //MIGBO
