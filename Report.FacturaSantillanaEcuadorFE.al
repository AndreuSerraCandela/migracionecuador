report 55037 "Factura Santillana Ecuador FE"
{
    ...
    // 002         LDP      10/09/2024       SANTINAV-6697
    DefaultLayout = RDLC;
    RDLCLayout = './FacturaSantillanaEcuadorFE.rdlc';
    ...
    dataset
    {
        dataitem("Documento FE"; "Documento FE")
        {
            ...
            column(numeroGuia; SIH."Numero Guia")
            {
            }
            column(nombreGuia; SIH."Nombre Guia")
            {
            }
            ...
            column("NÚMERO_DE_AUTORIZACIÓNCaption"; NÚMERO_DE_AUTORIZACIÓNCaptionLbl)
            {
            }
            ...
            column(ShiptoAddCode; ShiptoAdd.Code)
            {
            }
            column(ShiptoAddName; SIH."Ship-to Name")
            {
            }
            column(PaymentMethoDDescrip; PaymentDescr)
            {
            }
            column(DesFormaPagoSri; FormaPagoSRI)
            {
            }
            ...
            begin
                ...
                */
                            ...
                            '2':
                                begin  //IVA
                                    case recImpuestosFE."Codigo Porcentaje" of
                                        ...
                                        '3':
                                            begin
                                                decTotal14 += recImpuestosFE.Subtotal;
                                                decIVA14 += recImpuestosFE.Valor;
                                                if TIPOIVA then begin
                                                    SUBTOTAL_movil := 'SUBTOTAL 12%';
                                                    IVA_movil := 'IVA 12%';
                ...
                // ++ YFC 001
                SIH.Get("Documento FE"."No. documento");


                ShiptoAdd.Reset;
                ShiptoAdd.SetRange(Code, SIH."Ship-to Code");
                ...
                PaymentMethod.Reset;
                PaymentMethod.SetRange(Code, SIH."Payment Method Code");
                if PaymentMethod.FindSet then
                    PaymentDescr := PaymentMethod.Description;

                //002+
                Clear(FormaPagoSRI);
                // SATPaymentMethod.Reset;
                // //SATPaymentMethod.SetRange(Code, PaymentMethod."SAT Method of Payment");
                // if SATPaymentMethod.FindFirst then
                //     FormaPagoSRI := SATPaymentMethod.Description;
                //002-
    ...
    var
        ...
        "NÚMERO_DE_AUTORIZACIÓNCaptionLbl": Label 'NÚMERO DE AUTORIZACIÓN';
