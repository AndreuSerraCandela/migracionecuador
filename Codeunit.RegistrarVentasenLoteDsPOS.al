codeunit 76073 "Registrar Ventas en Lote DsPOS"
{
    ...
    begin
        ...
        //ERROR('Antes de lanzar este proceso conviene haber delimitado los documentos pendientes a registrar');
    ...
    procedure InsertarDetalleSIC(prCab: Record "Sales Header"; pProceso: Option Registro,Liquidacion,Firma; pError: Boolean; pTexto: Text; NumLog: Integer)
    var
        rLinLog: Record "Detalle Log Registro DsPOS";
    begin
        ...
        //             //prCab."Document Type"::Order:
        //             //"Tipo Documento" := "Tipo Documento"::Pedido;
    ...
    procedure LiquidarRegistradosSIC(NumLog: Integer)
    var
        recCabVta: Record "Sales Header";
        recCabFac: Record "Sales Invoice Header";
        recCabNC: Record "Sales Cr.Memo Header";
