page 76236 "Hist. acciones de personal"
{
    ApplicationArea = all;
    Caption = 'Historical personnel actions';
    Editable = false;
    PageType = List;
    SourceTable = "Hist. Acciones de personal";
        ...
        area(navigation)
        {
            group("&Actions")
            {
                ...
                action(Print)
                {
                    ...
                    trigger OnAction()
                    var
                        Acciones: Record "Hist. Acciones de personal";
                        RepAcciones: Report "Hist Acciones de personal";
                    begin
                        CurrPage.SetSelectionFilter(Acciones);
                        REPORT.Run(REPORT::"Hist Acciones de personal", true, true, Acciones);
                    end;
                }
                separator(Action1000000058)
                {
                }
                action(corregir)
                {
                    ...
                    trigger OnAction()
                    var
                        Accionesdepersonal: Record "Acciones de personal";
                    begin
