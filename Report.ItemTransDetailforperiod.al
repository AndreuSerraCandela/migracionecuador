report 50006 "Item Trans. Detail for period"
{
    // #7314   09/10/2015      MOI           Desarrollo Activo/Inactivo
    //         14/02/2017      PLB           Implementada funcionalidad
    DefaultLayout = RDLC;
    RDLCLayout = './ItemTransDetailforperiod.rdlc';

    Caption = 'Item Transaction Detail for period';
    ...
    dataset
    {
        dataitem(Item; Item)
        {
            ...
            column(ReportNameCaption; Report_Name_Label)
            {
            }
    ...
    var
        ...
        Report_Name_Label: Label 'Inventory: details of movs.';
}
