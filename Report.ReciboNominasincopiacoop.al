report 76066 "Recibo Nomina sin copia - coop"
{
    DefaultLayout = RDLC;
    RDLCLayout = './ReciboNominasincopiacoop.rdlc';
    ...
    dataset
    {
        dataitem("Historico Cab. nomina"; "Historico Cab. nomina")
        {
            ...
            {
                DataItemLink = "No. empleado" = FIELD ("No. empleado"), "Tipo de nomina" = FIELD ("Tipo de nomina"), "Período" = FIELD ("Período"), "Job No." = FIELD ("Job No.");
                DataItemTableView = SORTING ("No. empleado", "Tipo de nomina", "Período", "No. Orden") WHERE ("Texto Informativo" = CONST (false));
                ...
                column("Recibo_de_nómina_períodoCaption"; TextoTipoNomina)
                {
                }
            ...
            begin
                ...
                */
                ...
                if MiembrosCoop.Get("No. empleado") then begin
                    ...
                    TextoCoop := StrSubstNo(Text001, "No. empleado" + ' - ' + "Full name", MiembrosCoop.FieldCaption("Ahorro acumulado"), Format(MiembrosCoop."Ahorro acumulado", 0, '<Integer thousand><Decimals,3>'),
                                  MiembrosCoop.FieldCaption("Importe pendiente"), Format(MiembrosCoop."Importe pendiente", 0, '<Integer thousand><Decimals,3>'));
                end;

                TextoTipoNomina := StrSubstNo(Recibo_de_nómina_períodoCaptionLbl, "Tipo de nomina");
                ...
                if "Historico Lin. nomina".FindFirst then
                    TextoInformativo := "Historico Lin. nomina".Descripción + ', ' + Format("Historico Lin. nomina".Total);
    ...
    var
        ...
        MiembrosCoop: Record "Miembros cooperativa";
        ...
        "Recibo_de_nómina_períodoCaptionLbl": Label 'Payment slip payroll %1, period';
