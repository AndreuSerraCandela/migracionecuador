codeunit 76010 "Func. Cuestionario Evaluacion"
{
    ...
    var
        ...
        ContProfileAnswer: Record "Parametros vacaciones";
        Valid: Boolean;
    begin
        ...
        if ProfileQuestnHeader.Find('-') then
            ...
            IF NOT Valid THEN BEGIN
              ...
              ContProfileAnswer.SETRANGE(Desde,Emp."No.");
    ...
    procedure LookupName(var ProfileQuestnHeaderCode: Code[20]; var ProfileQuestnLine: Record "Lin. Cuestionario Evaluacion"; var Emp: Record Employee)
    begin
        Commit;
        FindLegalProfileQuestionnaire(Emp);
        if ProfileQuestnHeaderTemp.Get(ProfileQuestnHeaderCode) then;
