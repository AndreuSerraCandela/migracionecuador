xmlport 76060 "Configuraciones nomina"
{
    Direction = Import;
    Format = VariableText;
    ...
    schema
    {
        textelement(ConfiguracionNominas)
        {
            ...
            tableelement("Dimensiones Contabilizacion"; "Dimensiones Contabilizacion")
            {
                XmlName = 'DimensionesContabilizacion';
                fieldelement(DC_CodDimension; "Dimensiones Contabilizacion"."Cod. Dimension")
                {
                }
                fieldelement(DC_Orden; "Dimensiones Contabilizacion".Orden)
                {
                }
                fieldelement(DC_Descripcion; "Dimensiones Contabilizacion".Descripcion)
                {
                }
            }
            ...
            tableelement("Param. Inic. Conceptos Sal."; "Param. Inic. Conceptos Sal.")
            {
                XmlName = 'ParamInicConceptosSal';
                fieldelement(PICS_Codigo; "Param. Inic. Conceptos Sal.".Codigo)
                {
                }
                fieldelement(PICS_Descripcion; "Param. Inic. Conceptos Sal.".Descripcion)
                {
                }
                fieldelement(PICS_TipoConcepto; "Param. Inic. Conceptos Sal."."Tipo concepto")
                {
                }
                fieldelement(PICS_InicializaCantidad; "Param. Inic. Conceptos Sal."."Inicializa Cantidad")
                {
                }
                fieldelement(PICS_InicializaImporte; "Param. Inic. Conceptos Sal."."Inicializa Importe")
                {
                }
            }
        }
