report 76385 "Hist Acciones de personal"
{
    DefaultLayout = RDLC;
    RDLCLayout = './HistAccionesdepersonal.rdlc';

    dataset
    {
        dataitem("Hist. Acciones de personal"; "Hist. Acciones de personal")
        {
            ...
            begin
                ...
                if not Emp.Get("No. empleado") then begin
                    ...
                    if rCandidates.Get("No. empleado") then begin
                        ...
                        //Comentado Edad := FuncionesNom.CalculoEntreFechaDotNet('YYYY', CreateDateTime(rCandidates."Birth Date", Time), CurrentDateTime);
                    end;
                    ...
                    //Comentado Edad := FuncionesNom.CalculoEntreFechaDotNet('YYYY', CreateDateTime(Emp."Birth Date", Time), CurrentDateTime);
    ...
    var
        ...
        User: Record User;
        //Comentado FuncionesNom: Codeunit "Funciones Nomina";
        MarcaCargo: Boolean;
