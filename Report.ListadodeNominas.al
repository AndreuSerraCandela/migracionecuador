report 76000 "Listado de Nominas"
{
    DefaultLayout = RDLC;
    RDLCLayout = './ListadodeNominas.rdlc';
    ...
    dataset
    {
        dataitem("Historico Cab. nomina"; "Historico Cab. nomina")
        {
            ...
            RequestFilterFields = "Tipo de nomina", "Período", "No. empleado", "Job No.", "Frecuencia de pago", "Forma de Cobro";
            ...
            begin
                ...
                if recLinNom.FindSet then
                    repeat
                        ...
                        ConfigListados.SetRange("ID Reporte", 76000);
