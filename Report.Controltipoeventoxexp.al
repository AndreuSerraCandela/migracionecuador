report 76209 "Control tipo evento x exp."
{
    DefaultLayout = RDLC;
    RDLCLayout = './Controltipoeventoxexp.rdlc';

    dataset
    {
        dataitem(Eventos; "Programac. Talleres y Eventos")
        {
            DataItemTableView = SORTING(Expositor, "Fecha programacion");
            ...
            column(Eventos__Fecha_programacion_Caption_Control1000000041; Eventos__Fecha_programacion_Caption_Control1000000041Lbl)
            {
            }
            ...
            begin
                ...
                if Expositor <> codExpositor then begin
                    Clear(intTotalEsperados);
                    Clear(intTotalReal);
                    Clear(intSecuencia);
                    codExpositor := Expositor;
                end;
    ...
    var
        ...
        Eventos__Fecha_programacion_Caption_Control1000000041Lbl: Label 'Fecha';
        Eventos__Cod__Colegio_CaptionLbl: Label 'Expositor:';
