table 76427 "_Autoriz. Manuales TPV BO"
{
    // #81410  17/07/2017  PLB: Renumerado a 76408
        ...
        field(20; Autorizacion; Code[30])
        {
            ...
            begin
                ...
                if rLinSerie.FindFirst then begin
                    ...
                    "Nº Inicial" := rLinSerie."Starting No.";
                    "No Final" := rLinSerie."Ending No.";
                    rCabSeries.Get(rLinSerie."Series Code");
                    Descripción := rCabSeries.Description;
                end;
            end;
        }
