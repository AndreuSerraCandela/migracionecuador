report 55002 "Fact. Pto. Vta. Ecuador"
{
    // #1379 CAT 08/01/14 Printamos la forma de pago.
    DefaultLayout = RDLC;
    RDLCLayout = './FactPtoVtaEcuador.rdlc';
    ...
    dataset
    {
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            trigger OnAfterGetRecord()
            var
                rLocFormaPagoTPV: Record "Formas de Pago";
            begin
    ...
    var
        ...
        PTPV: Record "Pagos TPV";
        FPTPV: Record "Formas de Pago";
