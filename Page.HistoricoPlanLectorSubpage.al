page 76248 "Historico Plan Lector Subpage"
{
    ApplicationArea = all;
    DeleteAllowed = false;
    Editable = false;
    ...
    ModifyAllowed = false;
    PageType = ListPart;
    SourceTable = "Historico Plan Lector Det.";
    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                field("Universo de Títulos u Obras"; rec."Universo de Títulos u Obras")
                {
                }
                field("Adopción real"; rec."Adopción real")
                {
                }
