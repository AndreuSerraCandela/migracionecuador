report 56030 "Estadisticas de Vtas."
{
    // 
    //  WHERE(Item Ledger Entry Type=FILTER(Sale),Invoiced Quantity=FILTER(<>0))
    // MOI - 29/01/2015(#10375): Se añade el Global Dimension 1 Code en el campo TotalFor__Dim1
    DefaultLayout = RDLC;
    RDLCLayout = './EstadisticasdeVtas.rdlc';
    ...
    dataset
    {
        dataitem("Value Entry"; "Value Entry")
        {
            ...
            column(TotalFor___Dim1; TotalFor + Dim1 + "Global Dimension 1 Code")
            {
            }
