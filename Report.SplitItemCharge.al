report 56023 "Split Item Charge"
{
    ...
    var
        T39: Record "Purchase Line";
        T121: Record "Purch. Rcpt. Line";
        T5747: Record "Transfer Receipt Line";
        DimID: Integer;
    begin
        case ICAPurchase."Applies-to Doc. Type" of
            ICAPurchase."Applies-to Doc. Type"::Quote: //quote
            ...
            ICAPurchase."Applies-to Doc. Type"::Order: //Order
                begin
                    ...
                    */
                    if T39.Get(T39."Document Type"::Order, ICAPurchase."Applies-to Doc. No.", ICAPurchase."Applies-to Doc. Line No.") then begin
                        PurchLine."Dimension Set ID" := T39."Dimension Set ID";
                        PurchLine.Modify;
                    end;
            ...
            ICAPurchase."Applies-to Doc. Type"::Invoice: //Invoice
                begin
                    ...
                    IF DocDim2.FIND('-') THEN
                       ...
                       UNTIL DocDim2.NEXT = 0;
                    */
                    if T39.Get(T39."Document Type"::Invoice, ICAPurchase."Applies-to Doc. No.", ICAPurchase."Applies-to Doc. Line No.") then begin
                        PurchLine."Dimension Set ID" := T39."Dimension Set ID";
                        PurchLine.Modify;
                    end;
            ...
            ICAPurchase."Applies-to Doc. Type"::Receipt: //Receipt
                begin
                    ...
                    */
                    if T121.Get(ICAPurchase."Applies-to Doc. No.", ICAPurchase."Applies-to Doc. Line No.") then begin
                        PurchLine."Dimension Set ID" := T121."Dimension Set ID";
                        PurchLine.Modify;
                    end;
            ...
            ICAPurchase."Applies-to Doc. Type"::"Transfer Receipt": //Transfer Receipt
                begin
                    ...
                    IF PostedDocDim.FIND('-') THEN
                       ...
                       UNTIL PostedDocDim.NEXT = 0;
                    */
                    if T5747.Get(ICAPurchase."Applies-to Doc. No.", ICAPurchase."Applies-to Doc. Line No.") then begin
                        PurchLine."Dimension Set ID" := T5747."Dimension Set ID";
                        PurchLine.Modify;
                    end;
