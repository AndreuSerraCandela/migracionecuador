table 80272 "_Check Ledger Entry"
{
    ...
    fields
    {
        ...
        {
            CalcFormula = Lookup("Bank Account Ledger Entry".Beneficiario WHERE("Entry No." = FIELD("Bank Account Ledger Entry No.")));
            Caption = 'Beneficiary';
