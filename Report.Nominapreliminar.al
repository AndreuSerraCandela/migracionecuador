report 76031 "Nomina preliminar"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Nominapreliminar.rdlc';
    ...
    dataset
    {
        dataitem("Perfil Salarial"; "Perfil Salarial")
        {
            ...
            column("Histórico_Lín__nómina_Descripción"; Descripcion)
            {
            }
            column("Histórico_Lín__nómina__Concepto_salarial__Control14"; "Concepto salarial")
            {
            }
            column("Histórico_Lín__nómina_Descripción_Control17"; Descripcion)
            {
            }
            column("Histórico_Lín__nómina_Cantidad"; Cantidad)
            {
            }
            column("Histórico_Lín__nómina_Total"; Importe)
            {
            }
            ...
            column("Histórico_Lín__nómina_Total_Control7"; Importe)
            {
            }
            column("Histórico_Lín__nómina_Cantidad_Control1000000000"; Cantidad)
            {
            }
            column("Histórico_Lín__nómina_Total_Control10"; Importe)
            {
            }
            ...
            column("Histórico_Lín__nómina_TotalCaption"; FieldCaption(Importe))
            {
            }
            ...
            column("Histórico_Lín__nómina_Tipo_Nómina"; "Tipo Nomina")
            {
            }
