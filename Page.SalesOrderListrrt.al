page 53600 "Sales Order Listrrt"
{
    ApplicationArea = all;
    ...
    // #830    29/04/2014      CAT           Nuevo campo "Aprobado cobros"
    // 003     22/09/2014      RRT           Mostrar el alias del cliente (Campo Search Name). Se considera el cliente al que se
    //                                       realiza la venta, no al cliente de la factura.
