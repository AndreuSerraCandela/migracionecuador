page 56058 "Pre-Transfer Order (Consig.)"
{
    ApplicationArea = all;
    // Documentation()
    ...
    // 008     05-Marzo-12     AMS           Importa lineas desde excel
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Cod. Direccion Envio"; rec."Cod. Direccion Envio")
                {
                }
            ...
            group("Transfer-to")
            {
                ...
                field("Transfer-to Contact2"; rec."Transfer-to Contact")
                {
                }
                field("Receipt Date2"; rec."Receipt Date")
                {
        ...
        area(factboxes)
        {
            ...
            part(Control1000000028; "Transfer Line FactBox")
            {
