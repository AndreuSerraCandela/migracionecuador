table 50018 "Sales Invoice Line (TMP)"
{
    ...
    fields
    {
        ...
        {
            Caption = 'Description';
            Description = 'Ampliación para la descripción (Petición José Rafael). ESL';
        }
        ...
        {
            Description = 'Añadido para la reclasificación de productos.';
        ...
        {
            Caption = 'Order type';
            Description = 'Añadido para el desarrollo de pedidos consignacion (ESL).';
